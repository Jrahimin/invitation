    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            <table class="table table-bordered table-striped {{ count($events) > 0 ? 'datatable' : '' }} @can('event_delete') @if ( request('show_deleted') != 1 ) dt-select @endif @endcan">
                ...
                <tr>
                    ...
                    <th>@lang('global.events.fields.venue_name')</th>
                    <th>@lang('global.events.fields.venue_address')</th>
                    <th>@lang('global.events.fields.total_cost')</th>
                    <th>@lang('global.events.fields.total_guest')</th>
        ...
        'route' => ['admin.events.perma_del', $event->id])) !!}
                            ...
                            @else
                                <td>
                                    @can('event_view')
                                        <a href="{{ route('admin.events.send',[$event->id]) }}"
